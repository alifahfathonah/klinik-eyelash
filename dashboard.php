                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="sumber" class="form-control" id="sumber" placeholder="Sumber">
                                                                                                    <option value=""></option>
                                                                                                    <option value="IG" <?php if (!empty($data['sumber'] == 'IG')) { echo "selected"; } ?> > Instagram </option>
                                                                                                    <option value="Teman" <?php if (!empty($data['sumber'] == 'Teman')) { echo "selected"; } ?> > Teman </option>
                                                                                                    <option value="Iklan" <?php if (!empty($data['sumber'] == 'Iklan')) { echo "selected"; } ?> > Iklan </option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="id_cabang" class="form-control" id="id_cabang" placeholder="Cabang">
                                                                                                    ...
                                                                                                    foreach ($query1 as $d) {
                                                                                                        ?>
                                                                                                        <option value="<?php echo $d['id_cabang'] ?>" <?php if (!empty($d['id_cabang'] == $data['cabangs'])) { echo "selected"; } ?> > <?php echo $d['nama_cabang'] ?></option>
                                                                                                    <?php } ?>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                                ...
                                                                                                <select name="id_produk" id="id_produk" class="form-control" onchange="changeValueEdit(this.value)" placeholder="Nama Produk">
                                                                                                    ...
                                                                                                    if (mysqli_num_rows($barang)) { ?>
                                                                                                        <?php while ($row_brg = mysqli_fetch_array($barang)) { ?>
                                                                                                            <option value="<?php echo $row_brg["id_produk"] ?>" <?php if (!empty($row_brg["id_produk"] == $data['produks'])) { echo "selected"; } ?> > <?php echo $row_brg["nama_produk"] ?> </option>
                                                                                        ...
                                                                                        <div class="col-sm-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="id_jabatan" class="form-control" id="id_jabatan">
                                                                                                    <option value=""></option>
                                                                                                    <option value="1" <?php if ($data['jabatan_events'] == '1') { echo "selected"; } else { } ?>> Senior </option>
                                                                                                    <option value="2" <?php if ($data['jabatan_events'] == '2') { echo "selected"; } else { } ?>> Junior </option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="id_users" class="form-control" id="id_users" placeholder="Nama Pemasang">
                                                                                                    ...
                                                                                                    foreach ($query as $d) { ?>
                                                                                                        <option value="<?php echo $d['id_users'] ?>" <?php if ($d['id_users'] == $data['pemasangs']) { echo "selected"; } else { } ?>> <?php echo $d['username'] ?></option>
                                                                                                    <?php } ?>
                                                                                        ...
                                                                                        <div class="col-sm-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select name="warna" class="form-control" id="color" placeholder="Status">
                                                                                                    <option value=""></option>
                                                                                                    <option style="color:#008000;" value="#008000" <?php if ($data['warna'] == "#008000") { echo "selected"; } else { } ?>>&#9724; Sudah Bayar / Lunas </option>
                                                                                                    <option style="color:#0071c5;" value="#0071c5" <?php if ($data['warna'] == "#0071c5") { echo "selected"; } else { } ?>>&#9724; Masih DP </option>
                                                                                                    <option style="color:#FF0000;" value="#FF0000" <?php if ($data['warna'] == "#FF0000") { echo "selected"; } else { } ?>>&#9724; Belum Bayar </option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
