                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    if (!empty($cari)) { 
                                        ...
                                        $cari10 = date('d F Y', strtotime($cari10));
                                        ?>
                                        <strong><p>Tanggal : <?php echo $cari ?></p></strong>
                                    <?php }else{ ?>
                                        <strong><p>Tanggal : <?php echo $cari10 ?></p></strong>
                                    <?php } ?>
                                </div>
                            </div>
                        </form>
                                    ...
                                    <div class="dt-responsive table-responsive">
                                        <table id="user-list-tableee" class="table nowrap">
                                            ...
                                            <tbody>
                                                ...
                                                $no = 1;
                                                $tgl = date('Y-m-d');
                                                $query = mysqli_query($link,"SELECT DISTINCT a.jam, b.start_jam, a.id_slot, b.start
                                                    FROM tbl_slot a 
                                                    LEFT JOIN events b ON a.id_slot = b.id_slot
                                                    WHERE a.id_cabang = 1
                                                    AND a.id_jabatan = 1
