...
if(isset($_POST['submit'])){ 
  ...
  $query="INSERT INTO komplain(id_pemesanan, kode_customer, komplain, date_created, date_updated) values('$id_pemesanan', '$kode_customer', '$komplain', '$date_created', '$date_updated')";
